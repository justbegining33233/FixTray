                    ...
                    >
                      ...
                      <div style={{ fontSize: 13, color: amount == null ? '#f59e0b' : '#22c55e', marginTop: 6 }}>
                        {listed == null
                          ? 'No estimate yet'
                          : listed.serviceFee > 0
                            ? `Estimate $${listed.total.toFixed(2)} · ${FIXTRAY_SERVICE_FEE_LABEL} $${listed.serviceFee.toFixed(2)}`
          ...
          <div style={{ background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(34,197,94,0.3)', borderRadius: 12, padding: 24 }}>
            ...
            <div style={{ marginTop: 16, color: '#e5e7eb' }}>
              ...
              {estimateBill.serviceFee > 0 && (
                <div>{FIXTRAY_SERVICE_FEE_LABEL}: ${estimateBill.serviceFee.toFixed(2)}</div>
              )}
              <div style={{ color: '#22c55e', fontWeight: 700, fontSize: 18 }}>Total: ${estimateBill.total.toFixed(2)}</div>
            </div>
