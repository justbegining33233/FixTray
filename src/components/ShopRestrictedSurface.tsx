  ...
  return (
    <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: '#000', color: '#e5e7eb', padding: 24 }}>
      <div style={{ maxWidth: 520, textAlign: 'center' }}>
        <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 12 }}>Forbidden</h1>
        <p style={{ color: '#9aa3b2', lineHeight: 1.6, marginBottom: 12 }}>{title}</p>
        <p style={{ color: '#9aa3b2', lineHeight: 1.6, marginBottom: 24 }}>
          {detail || 'Shop Settings → Security still has two-factor authentication and active sessions. Platform admin tools stay off this account.'}
        </p>
