    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: '#000000' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        <main style={{ flex: 1, padding: 24, maxWidth: 1200, margin: '0 auto', width: '100%' }}>
          <Breadcrumbs />
          <h1 style={{ fontSize: 28, fontWeight: 700, color: '#e5e7eb', margin: '16px 0 8px' }}><FaLock style={{ marginRight: 8 }} /> Team Permissions</h1>
          <p style={{ color: '#9aa3b2', fontSize: 14, marginBottom: 24 }}>
            Review and update what each team member can access.
          </p>
