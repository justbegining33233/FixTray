...
const shopNav: MobileRoleNav = {
  ...
  more: [
    section('Work', [
      ...
      link('In-Shop Work Order', '/shop/jobs', 'orders'),
      link('Roadside Work Order', '/workorders/roadside', 'pin'),
      link('Work Orders', '/shop/jobs', 'orders'),
      link('Work Order List', '/shop/jobs', 'clipboard'),
...
const managerNav: MobileRoleNav = {
  ...
  more: [
    section('Jobs', [
      ...
      link('Work Orders', '/manager/assignments', 'orders'),
    ]),
    section('People', [
