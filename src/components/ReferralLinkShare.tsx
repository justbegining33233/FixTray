  ...
  return (
    <div className="w-full max-w-md mx-auto p-6 bg-gradient-to-br from-slate-900 to-slate-800 rounded-lg border border-slate-700 shadow-lg">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold text-white">{say("Share & Earn")}</h3>
      </div>

      <p className="text-sm text-slate-400 mb-4">
        {say("Share your unique referral code and earn rewards when friends sign up.")}{' '}</p>

      {/* Referral Code Display */}
      <div className="mb-4">
        <label className="text-xs text-slate-500 uppercase tracking-wider">{say("Your Referral Code")}</label>
      ...
      {/* Referral Link */}
      <div className="mb-4">
        <label className="text-xs text-slate-500 uppercase tracking-wider">{say("Your Referral Link")}</label>
        <div className="flex gap-2 mt-2">
          <input
            type="text"
            value={referralLink}
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        >
          ...
          <span className="text-xs text-slate-400">{say("Email")}</span>
        </button>
        ...
        >
          ...
          <span className="text-xs text-slate-400">{say("Text")}</span>
        </button>
        ...
        >
          ...
          <span className="text-xs text-slate-400">{say("WhatsApp")}</span>
        </button>
      </div>
      ...
      <div className="mt-4 pt-4 border-t border-slate-700">
        <div className="grid grid-cols-2 gap-4 text-center">
          <div>
            ...
            <p className="text-xs text-slate-500">{say("Referrals Sent")}</p>
          </div>
          <div>
            <p className="text-2xl font-bold text-green-400">$0</p>
            <p className="text-xs text-slate-500">{say("Rewards Earned")}</p>
          </div>
        </div>
      </div>
    </div>
