...
export default function WorkOrderListRedirect() {
  ...
  return (
    <main style={{ minHeight: '100vh', display: 'grid', placeItems: 'center', background: '#000000', color: '#e5e7eb' }}>
      <h1 style={{ position: 'absolute', width: 1, height: 1, overflow: 'hidden', clipPath: 'inset(50%)', whiteSpace: 'nowrap' }}>{say("Work Order List Redirect")}</h1>
      {say("Redirecting to your work order list...")}{' '}</main>
  );
}
